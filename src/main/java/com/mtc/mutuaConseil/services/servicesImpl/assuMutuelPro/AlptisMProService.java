...
public class AlptisMProService extends BasePlaywrightService implements LaunchedService {
    ...
    private static final String PROVIDER = "mutuelPro/alptis-mp";
    ...
    public AlptisMProService(TypeAssuranceService typeAssuranceService, SelectorStore selectors) {
    ...
    private void remplirAdherents(FluxData flux) {
        ...
        choixRegime(flux, 0);
        elementLib.randomWait(1500, 2500);
        elementLib.humanTypeById(sel("adherent.postal_code_id"), flux.getPersonnes().getFirst().getCodePostal());
    }
