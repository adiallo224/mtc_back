...
@Service
public class AprilMutuelProService extends PageElementInteraction implements LaunchedService {

    private final Logger log = LoggerFactory.getLogger(AprilMutuelProService.class);
    public static WebDriver driver;
    private final String source = "AprilMutuelProService";
    ...
    public Tarif getResultFrom(Compte c, FluxData flux) {
        ...
        try {
            ...
            waitThread(7);
            WebElement sectionPrix = waitForElement(driver, By.name("//section[@class='pc-results__recommendations'][1]"), 25, 1);
            waitThread(2);
...
//                 scrollDown(driver, 0, 500);
    ...
    public void connexion(Compte c) {
        ...
        InformationsUser.infoLogin(driver, By.name("login"), 10, 2, c.getUsername());
        InformationsUser.infoPassword(driver, By.name("password"), 10, 2, c.getPassword());
        waitThread(2);
        WebElement buttonLogin = waitForElement1(driver, By.xpath("//button[normalize-space()='CONNEXION']"), 20, 2);
        buttonLogin.click();
    }
