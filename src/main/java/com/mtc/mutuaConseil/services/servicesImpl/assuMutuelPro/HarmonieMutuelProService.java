...
@Service
public class HarmonieMutuelProService extends PageElementInteraction implements LaunchedService {

    private final Logger log = LoggerFactory.getLogger(HarmonieMutuelProService.class);
    public static WebDriver driver;
    private final String source = "HarmonieMutuelProService";
