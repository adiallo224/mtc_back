...
@Service
public class QuatremTNSMutuelProService extends PageElementInteraction implements LaunchedService {

    private final Logger log = LoggerFactory.getLogger(QuatremTNSMutuelProService.class);
    public static WebDriver driver;
    private final String source = "QuatremTNSMutuelProService";
