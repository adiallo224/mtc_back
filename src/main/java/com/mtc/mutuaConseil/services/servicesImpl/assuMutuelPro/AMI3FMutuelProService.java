...
@Service
public class AMI3FMutuelProService extends PageElementInteraction implements LaunchedService {

    private final Logger log = LoggerFactory.getLogger(AMI3FMutuelProService.class);
    public static WebDriver driver;
    private final String source = "AMI3FMutuelProService";
