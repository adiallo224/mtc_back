...
@Service
public class ApicilMutuelProService extends PageElementInteraction implements LaunchedService {

    private final Logger log = LoggerFactory.getLogger(ApicilMutuelProService.class);
    public static WebDriver driver;
    private final String source = "ApicilMutuelProService";
