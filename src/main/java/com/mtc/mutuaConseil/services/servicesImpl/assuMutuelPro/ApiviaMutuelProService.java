...
@Service
public class ApiviaMutuelProService extends PageElementInteraction implements LaunchedService {

    private final Logger log = LoggerFactory.getLogger(ApiviaMutuelProService.class);
    public static WebDriver driver;
    private final String source = "ApiviaMutuelProService";
